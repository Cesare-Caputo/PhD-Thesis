...
#### Note that seems to be learning faster than with jjust otal demand and supply
...
#model.save("ppo_wtw_decent_v1.3")

# env with linking and building new plant option VERSION 3

env = WtwEnvSimple_v3()
# we leave on same tensorboard to see improvements in performance visually
tensorboard_log = "./sb3_wtw_test_v3"
log_dir = "./sb3_wtw_ppo_test_v3/"
...
#model.save("ppo_wtw_decent_v3.3")


# eval_env = gym.make('gym_garage:garage-v2')
