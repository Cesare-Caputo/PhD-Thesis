...
ACTION_4 = 15 #ML/d of NEW  WTW capacity
...
class WtwEnvSimple_v3(gym.Env):
    ...
    def step(self, action):
      ...
      #NOTE to retrieve option class and cost from other code
        ...
        elif action ==3: ## lNew WTW NOTE THAT LINKING WITH ASSYNT DID NOT WORK
        ...
        elif action ==4: ## building new plant
            new_wtw = OptionSupply(
                name='New source &  WTW',
                increase=15,
                enhancement=50.9,
