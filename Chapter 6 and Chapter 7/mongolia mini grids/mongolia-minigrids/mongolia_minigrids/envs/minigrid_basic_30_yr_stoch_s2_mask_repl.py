...
class MinigridBasic30yr_stoch_s2_mask_repl(gym.Env):
    ...
    def step(self, action):
        ...
        if action == 0:
           ...
           E_cost = pv_capex_s2(500)
           E_cost_pv = pv_capex_s2(500)
           ...
           E_cost = wind_capex_s2(500)
           E_cost_wind = wind_capex_s2(500) 
        ...
        if self.time_steps in self.batt_repl_yr:
            ...
            E_cost_pv = pv_capex_s2(500) # only replacing each expansion made
            E_cost += E_cost_pv
