...
class MinigridBasic30yr_stoch_s6_mask_repl(gym.Env):
    ...
    def step(self, action):
        ...
        if action == 0:
           ...
           E_cost = pv_capex_s6(500)
           E_cost_pv = pv_capex_s6(500)
           ...
           E_cost = wind_capex_s6(500)
           E_cost_wind = wind_capex_s6(500) 
           self.wind_repl_yr.append(self.time_steps + T_wind_m)
           self.inverter_repl_yr.append(self.time_steps + T_invert_m)
        elif action == 3:
           current_eh_capacity = current_eh_capacity + 500
           E_cost = eh_capex_s6(500)
           E_cost_eh = eh_capex_s6(500)
        ...
        if self.time_steps in self.batt_repl_yr:
            ...
            E_cost_pv = pv_capex_s6(500) # only replacing each expansion made
            E_cost += E_cost_pv
