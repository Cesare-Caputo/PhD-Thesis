...
class MinigridBasic30yr_stoch_s2_mask(gym.Env):
    ...
    def step(self, action):
        ...
        if action == 0:
           ...
           E_cost = expansion_cost_wind (3)
           E_cost_wind = expansion_cost_wind (3) 
        elif action == 3:
           current_eh_capacity = current_eh_capacity + 500
           E_cost = eh_capex_inflex(500)
           E_cost_eh = eh_capex_inflex(500)
       ...
       # calculate total costs for this year    
        ...
        info = { "CO2": monthly_co2, "Net Grid CF": net_grid_cashflow  , "Carbon Credit Revenue" : carbon_credit_revenue  , "CF PV":pv_cf , "CF Wind": wind_cf , "Electric Heater usage(kWh)": heat_generated_eh,   "Tranmission losses (kWh)" : tranmission_losses , "Distributed Energy(kWh)" : avg_tranmission_req, "Shortage amount (kWh)" : shortage ,   
