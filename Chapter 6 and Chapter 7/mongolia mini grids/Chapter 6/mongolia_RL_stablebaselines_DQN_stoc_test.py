...
model_acer = ACER(Mlp_a2c, train_env_monthly, gamma =1, verbose = 1,  tensorboard_log="./mongolia_minigrids_ppo_feb14/")
...
model_ppo = PPO1(Mlp_a2c, train_env_monthly, gamma =1, verbose = 1,  tensorboard_log="./mongolia_minigrids_ppo_feb14/")
