...
# model_dqn_lr_very_small_m_det = DQN(MlpPolicy, train_env_det_split, gamma =1, exploration_fraction = .6,   exploration_final_eps = .01, 
#               prioritized_replay=True ,  tensorboard_log="./mongolia_minigrids_10gers_determinstic/")
# model_dqn_adj_det = DQN(MlpPolicy, train_env_det_split, gamma =1, exploration_final_eps = .1,  exploration_fraction = .5, prioritized_replay=True ,  tensorboard_log="./mongolia_minigrids_10gers_determinstic/")
# model_dqn_df_det = DQN(MlpPolicy, train_env_det_split, gamma =1,  prioritized_replay=True ,  tensorboard_log="./mongolia_minigrids_10gers_determinstic/")

# model_dqn_small_mlp = DQN(CustomDQN_FF_Policy_small, train_env_det_split, gamma =1,  prioritized_replay=True ,  tensorboard_log="./mongolia_minigrids_10gers_determinstic/")
# model_dqn_small_mlp_norm = DQN(CustomDQN_FF_Policy_small_norm, train_env_det_split, gamma =1,  prioritized_replay=True ,  tensorboard_log="./mongolia_minigrids_10gers_determinstic/")

# model_ppo2_mongolia_df = PPO2(Mlp_a2c ,train_env_det_split, gamma =1,   tensorboard_log="./mongolia_minigrids_10gers_determinstic_optuna/")
model_trpo_mongolia_df = TRPO(Mlp_a2c ,train_env_30_yr, gamma =1,   tensorboard_log="./mongolia_minigrids_10gers_determinstic_30yr_complete/" )
# model_trpo_mongolia_df.learn(total_timesteps = 1000000)
# model_ppo2_mongolia_df.learn(total_timesteps = 1000000)
# # model_dqn_small_mlp.learn(total_timesteps = 100000)
# # model_dqn_small_mlp_norm.learn(total_timesteps = 100000)
model_trpo_mongolia_df.learn(total_timesteps = 100000)

# model_trpo_mongolia_df.save("trpo_mongolia_det_solid_ehpv_mainly")
...
# model_trpo_mongolia_df.save("mongolia_trpo_det_30yr_v2")
