...
def monthly_electricity_load(hourly_demand):
    tot_yearly = yearly_electricity_load(hourly_demand)
    tot_monthly = tot_yearly / 12 # assuming average month is 30 days
...
D_1m = D_1/12 # Projected year 1 demand, equal to 53.4
D_120m = D_10/ months_per_year  #additional demand by year 10, or month120
D_Fm= D_F/ months_per_year  # additional demand after year 10
