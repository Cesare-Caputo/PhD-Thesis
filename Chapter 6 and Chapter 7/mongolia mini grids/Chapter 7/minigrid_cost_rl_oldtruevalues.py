...
def monthly_opex_system (pv_capacity, battery_capacity, wind_capacity, diesel_required_kwh, inverter_capacity, coal_usage):
    opex = pv_capacity*pv_opex_m  + battery_capacity*battery_opex_m + wind_capacity*wind_opex_m + inverter_capacity*inverter_opex_m + monthly_opex_diesel(diesel_required_kwh) + coal_usage * coal_price_per_kg   # check if need to multiply by .001 to make kwh here
    return opex
...
def monthly_opex_inflexible (pv_capacity, battery_capacity):
    opex = pv_capacity*pv_opex_m  + battery_capacity*battery_opex_m 
    return opex
