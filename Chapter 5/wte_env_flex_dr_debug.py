...
#imaginary penalty for overbuilding bhevaiours
        ...
        total_revenue = elec_revenue + refuse_revenue
        ...
        reward = ncf_t / (1.08 ** self.time_steps) 
        ...
        info = {"tot transport cost" : self.total_transport_cost , "Income $" : elec_revenue , "disposal cost" : self.tot_disposal_costs , "Expansion Cost" : E_cost}
