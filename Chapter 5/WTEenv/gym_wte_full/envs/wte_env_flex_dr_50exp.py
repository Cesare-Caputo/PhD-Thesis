...
class WTE_EnvFull_50(gym.Env):
    ...
    def step(self, action):
        ...
        self.fw_demand_s1 = self.state[1]
        self.current_capacity_s2 = self.state[2]
        self.fw_demand_s2 = self.state[3]        
        self.current_capacity_s3 = self.state[4]
        self.fw_demand_s3 = self.state[5]
        self.current_capacity_s4 = self.state[6]
        self.fw_demand_s4 = self.state[7]        
        self.current_capacity_s5 = self.state[8]
        self.fw_demand_s5 = self.state[9]        
        self.current_capacity_s6 = self.state[10]
        self.fw_demand_s6 = self.state[11]        

#imaginary penalty for overbuilding bhevaiours
        if self.current_capacity_s1 == 600  and action ==1:
            revenue = -1 #tring imaginary penalty for overbuilding to prevent bhaviours, taken out in testing environment
        elif self.current_capacity_s2 == 600  and action ==2:
            revenue = -1 #tring imaginary penalty for overbuilding to prevent bhaviours, taken out in testing environment  
        elif self.current_capacity_s3 == 600  and action ==3:
            revenue = -1 #tring imaginary penalty for overbuilding to prevent bhaviours, taken out in testing environment  
        elif self.current_capacity_s4 == 600  and action ==4:
            revenue = -1 #tring imaginary penalty for overbuilding to prevent bhaviours, taken out in testing environment  
        elif self.current_capacity_s5 == 600  and action ==5:
            revenue = -1 #tring imaginary penalty for overbuilding to prevent bhaviours, taken out in testing environment  
        elif self.current_capacity_s6 == 600  and action ==6:
            revenue = -1 #tring imaginary penalty for overbuilding to prevent bhaviours, taken out in testing environment              
        ...
        reward = ncf_t / (1.08 ** self.time_steps) if self.time_steps !=0 else tot_capex_decentralized_s1(200)  
