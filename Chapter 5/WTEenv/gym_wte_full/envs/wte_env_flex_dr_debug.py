...
NOTHING = 0
EXPAND_50_unit_s1 = 1 
EXPAND_100_unit_s1 = 2
EXPAND_200_unit_s1 = 3
EXPAND_50_unit_s2 = 4 
EXPAND_100_unit_s2 = 5
EXPAND_200_unit_s2 = 6
EXPAND_50_unit_s3 = 7 
EXPAND_100_unit_s3 = 8
EXPAND_200_unit_s3 = 9
EXPAND_50_unit_s4 = 10 
EXPAND_100_unit_s4 = 11
EXPAND_200_unit_s4 = 12
EXPAND_50_unit_s5 = 13 
EXPAND_100_unit_s5 = 14
EXPAND_200_unit_s5 = 15
EXPAND_50_unit_s6 = 16 
EXPAND_100_unit_s6 = 17
EXPAND_200_unit_s6 = 18

s1_actions = [EXPAND_50_unit_s1,EXPAND_100_unit_s1, EXPAND_200_unit_s1 ]
s2_actions = [EXPAND_50_unit_s2,EXPAND_100_unit_s2, EXPAND_200_unit_s2 ]
s3_actions = [EXPAND_50_unit_s3,EXPAND_100_unit_s3, EXPAND_200_unit_s3 ]
s4_actions = [EXPAND_50_unit_s4,EXPAND_100_unit_s4, EXPAND_200_unit_s4 ]
s5_actions = [EXPAND_50_unit_s5,EXPAND_100_unit_s5, EXPAND_200_unit_s5 ]
s6_actions = [EXPAND_50_unit_s6,EXPAND_100_unit_s6, EXPAND_200_unit_s6 ]
...
class WTE_EnvFull_debug(gym.Env):
    ...
    def __init__(self):
        ...
        self.low = np.array([min_capacity, min_demand , min_capacity, 
        ...
        self.action_space = spaces.Discrete(19) # No expansion, expand 1,2, or 3 floors
        self.count = 0
        self.time_steps = 0
        self.time_to_end = T + 1
        # initialize capacities in various sectors
        self.current_capacity_s1 = 100 
    ...
    def step(self, action):
        ...
        if action == 0:
           ...
           E_cost = expansion_cost(50)
           self.current_capacity_s1 += 50
        elif action == 2:    
           E_cost = expansion_cost(100)
           self.current_capacity_s1 += 100
        elif action == 3:    
           ...
           E_cost = expansion_cost(50)
           self.current_capacity_s2 += 50
        elif action == 5:    
           E_cost = expansion_cost(100)
           self.current_capacity_s2 += 100
        elif action == 6:    
           E_cost = expansion_cost(200)
           self.current_capacity_s2 += 200
        elif action == 7:    
           E_cost = expansion_cost(50)
           self.current_capacity_s3 += 50
        elif action == 8:    
           E_cost = expansion_cost(100)
           self.current_capacity_s3 += 100
        elif action == 9:    
           E_cost = expansion_cost(200)
           self.current_capacity_s3 += 200           
        elif action == 10:    
           E_cost = expansion_cost(50)
           self.current_capacity_s4 += 50
        elif action == 11:    
           E_cost = expansion_cost(100)
           self.current_capacity_s4 += 100
        elif action == 12:    
           E_cost = expansion_cost(200)
           self.current_capacity_s4 += 200           
        elif action == 13:    
           E_cost = expansion_cost(50)
           self.current_capacity_s5 += 50
        elif action == 14:    
           E_cost = expansion_cost(100)
           self.current_capacity_s5 += 100
        elif action == 15:    
           E_cost = expansion_cost(200)
           self.current_capacity_s5 += 200           
        elif action == 16:    
           E_cost = expansion_cost(50)
           self.current_capacity_s6 += 50
        elif action == 17:    
           E_cost = expansion_cost(100)
           self.current_capacity_s6 += 100
        elif action == 18:    
           E_cost = expansion_cost(200)
        ...
        if self.current_capacity_s1 >= 600  and action in s1_actions:
            revenue = -1 #tring imaginary penalty for overbuilding to prevent bhaviours, taken out in testing environment
        elif self.current_capacity_s2 >= 600  and action in s2_actions:
            revenue = -1 #tring imaginary penalty for overbuilding to prevent bhaviours, taken out in testing environment  
        elif self.current_capacity_s3 >= 600  and action in s3_actions:
            revenue = -1 #tring imaginary penalty for overbuilding to prevent bhaviours, taken out in testing environment  
        elif self.current_capacity_s4 >= 600  and action in s4_actions:
            revenue = -1 #tring imaginary penalty for overbuilding to prevent bhaviours, taken out in testing environment  
        elif self.current_capacity_s5 >= 600  and action in s5_actions:
            revenue = -1 #tring imaginary penalty for overbuilding to prevent bhaviours, taken out in testing environment  
        elif self.current_capacity_s6 >= 600  and action in s6_actions:
            revenue = -1 #tring imaginary penalty for overbuilding to prevent bhaviours, taken out in testing environment 
        elif self.time_steps == T and action !=0:
            revenue = -1
        else:
